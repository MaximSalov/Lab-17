...
namespace lab17
{
    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            bAcc1.InputData(254832, 734628.78, "Салов Максим Валерьевич");
            bAcc1.ShowData();
            Console.WriteLine();

            BankAccount<string> bAcc2 = new BankAccount<string>();
            bAcc2.InputData("685334", 533980.24, "Иванов Иван Иванович");
            bAcc2.ShowData();
            Console.WriteLine();

            BankAccount<double> bAcc3 = new BankAccount<double>();
            bAcc3.InputData(721963, 628377.82, "Петров Петр Петрович");
            bAcc3.ShowData();
            Console.WriteLine();
